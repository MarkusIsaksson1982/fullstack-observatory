...
> **Live demo:** <https://hpc-observatory.vercel.app/> — interactive HPC dashboard with sample data. For the real-time experience (live scheduler, Prometheus, Grafana), clone this repo and run `docker compose up` per the Quick Start below.
